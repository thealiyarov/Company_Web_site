...
function Communication() {
  return (
    <div className="Communication-container flex justify-center bg-navColor">
      <div className="main flex w-[1170px] gap-[20px] items-center justify-center h-[500px] ">
        <div className="Communation-left w-[900px] h-[200px] flex">
        ...
        <div className="Communation-right w-[250px]">
